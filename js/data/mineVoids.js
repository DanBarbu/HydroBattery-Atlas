...
HB.Data.mineVoids = [
    ...
    //
    //  Screening-sieve records, not survey data:
    //  - Coordinates are locality-level approximations; upper/lower reservoir
    //    points are NOT yet pinned (drop markers to read real elevations and
    //    site reservoirs on uninhabited terrain per the design rule above).
    //  - Quarry heads are POTENTIAL, not intrinsic: every figure assumes a
    //    constructed upper reservoir on adjacent relief — realistic for the
    //    Macin-massif sites (Greci, Carjelari, Iacobdeal; terrain to ~467 m),
    //    marginal elsewhere. Only Altan Tepe has built-in head (its shaft).
    //  - Volumes are order-of-magnitude; storage uses ~0.0024 GWh/Mm3/m head.
    // -------------------------------------------------------
    {
        id: 'mv_altan_tepe',
        name: 'Altan Tepe Mine',
        country: 'Romania',
        ...
        status: 'potential',
        mine_type: 'underground',
        commodity: 'Copper/Pyrite',
        // Surface (hilltop) reservoir ~200 m ASL; deep workings reached via 770 m shaft.
        // Screening: ~700 m head, water volume ~2 Mm3 (range 1-4), ~3.4 GWh.
        upper_pit_elevation_m: 200,
        lower_pit_elevation_m: -500,
        head_m: 700,
        upper_pit_volume_m3: 2000000,
        ...
        water_contamination: {
            risk: 'high',
            contaminants: ['acid_mine_drainage', 'heavy_metals'],
            lower_reservoir_type: 'underground_workings',
            treatment_note: 'Pyrite-rich workings generate acid mine drainage (the mine had documented water-contamination problems before closure). Cycling water would require lining of workings or continuous treatment.'
        },
        capacity_mw: 400,
        storage_mwh: 3400,
        estimated_cost_musd: null,
    ...
    {
        id: 'mv_macin_greci',
        name: 'Macin-Greci / Muntele Carol Quarries',
        country: 'Romania',
        region: 'Tulcea County',
        lat: 45.06,
        lng: 28.20,
    ...
    },
    {
        ...
        status: 'potential',
        mine_type: 'open_pit',
        commodity: 'Granite/Limestone',
        upper_pit_elevation_m: 260,
        lower_pit_elevation_m: 60,
        head_m: 200,
        upper_pit_volume_m3: 2000000,
        lower_pit_volume_m3: 2000000,
    ...
    {
        id: 'mv_iacobdeal',
        name: 'Iacobdeal Quarry (Turcoaia)',
        country: 'Romania',
        region: 'Tulcea County',
        lat: 45.08,
        lng: 28.19,
        ...
        mine_type: 'open_pit',
        commodity: 'Granite',
        upper_pit_elevation_m: 230,
        lower_pit_elevation_m: 30,
        head_m: 200,
    ...
    },
    {
        ...
        status: 'potential',
        mine_type: 'open_pit',
        commodity: 'Road-stone',
        upper_pit_elevation_m: 170,
        lower_pit_elevation_m: 50,
        head_m: 120,
        upper_pit_volume_m3: 1500000,
        lower_pit_volume_m3: 1500000,
    ...
    {
        id: 'mv_murfatlar',
        name: 'Murfatlar-Basarabi Quarry',
        country: 'Romania',
        ...
        status: 'potential',
        mine_type: 'open_pit',
        commodity: 'Kaolin/Chalk',
        upper_pit_elevation_m: 80,
        lower_pit_elevation_m: 20,
        head_m: 60,
        upper_pit_volume_m3: 2000000,
        lower_pit_volume_m3: 2000000,
    ...
    },
    {
        ...
        status: 'potential',
        mine_type: 'open_pit',
        commodity: 'Granite/Aggregate',
        upper_pit_elevation_m: 90,
        lower_pit_elevation_m: 40,
        head_m: 50,
        upper_pit_volume_m3: 2000000,
        lower_pit_volume_m3: 2000000,
